...
import com.blit.ecommerce.project.service.EmailService;
...
public class PasswordController {
    ...
    public ModelAndView processForgotPasswordForm(ModelAndView modelAndView, @RequestParam("email") String userEmail, HttpServletRequest request) {
        ...
        if (!optional.isPresent()) {
            ...
            passwordResetEmail.setFrom("ecommerce.blit.september2023@gmail.com");
    ...
    public ModelAndView displayResetPasswordPage(ModelAndView modelAndView, @RequestParam("token") String token) {
        ...
        Optional<User> user = Optional.ofNullable(userService.findUserByResetToken(token));
    ...
    public ModelAndView setNewPassword(ModelAndView modelAndView, @RequestParam Map<String, String> requestParams, RedirectAttributes redir) {
        ...
        Optional<User> user = Optional.ofNullable(userService.findUserByResetToken(requestParams.get("token")));
